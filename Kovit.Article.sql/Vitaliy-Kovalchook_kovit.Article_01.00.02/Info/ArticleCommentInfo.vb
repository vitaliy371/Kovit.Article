...
#Region " Constructors "
		...
		Public Sub New(articleID As Integer, articleCommentText As String, email As String, name As String, approved As Boolean, ipAddress As String, createdByUserID As Integer, createdOnDate As DateTime)
