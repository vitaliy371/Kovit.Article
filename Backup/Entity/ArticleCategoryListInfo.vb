...
#Region " Constructors "
        ...
        Public Sub New(ByVal articleID As Integer, ByVal articleCategoryID As Integer)
...
#Region "ArticleCategoryList Data Access"
        ...
        Public Shared Sub DeleteThis(ByRef ErrorMessage As String, ByVal ArticleID As Integer, ByVal ArticleCategoryID As Integer)
            DataProvider.Instance().ExecuteNonQuery("ArticleCategoryListDeleteByArticleCategory", ErrorMessage, ArticleID, ArticleCategoryID)
        End Sub
